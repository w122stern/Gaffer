...
public class AnalyticOperationTest extends OperationTest<AnalyticOperation> {

    public void shouldJsonSerialiseAndDeserialise() {
        // Given
        final String testOpName = "testOpName";
        final Map testParamsMap = Collections.singletonMap("test", "testVal");
        AnalyticOperation op = (AnalyticOperation) new AnalyticOperation.Builder()
                .name(testOpName)
        ...
        final AnalyticOperation deserialisedOp = fromJson(json);
    ...
    public void shouldShallowCloneOperation() {
        ...
        AnalyticOperation clonedOp = op.shallowClone();
    ...
    @Override
    protected AnalyticOperation getTestObject() {
        return new AnalyticOperation();
    }
}
